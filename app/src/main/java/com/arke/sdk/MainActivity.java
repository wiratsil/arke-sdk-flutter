...
public class MainActivity extends ExpandableListActivity {
    ...
    private void initView() {
        ...
        simplePayFunctionList = addMap(simplePayFunctionList, FUNCTION, getString(R.string.sale_start_emv_process_first));
        simplePayFunctionList = addMap(simplePayFunctionList, FUNCTION, getString(R.string.sale_search_card_first));
